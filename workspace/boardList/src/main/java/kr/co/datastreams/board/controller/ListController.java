...
public class ListController  {
	...
	public String list(
		...
		int count = newBoardDAO.selectCount(); //전체 개시물 갯수
		int pageCount = count / RECORD;
		//System.out.println(pageCount);
		
		if(count % 5 > 0) pageCount++; //총 페이지 갯수 구하기
		List<BoardDTO> list = newBoardDAO.selectList(ipage); //한 페이지당 개시물 갯수
	...
	public String write(
		...
		newBoardDAO.writeBoard(boardDTO);
