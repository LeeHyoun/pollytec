...
function check(){
   ...
   if (document.mgradd.mgrname.value.match(/([^가-힣ㄱ-ㅎㅏ-ㅣ\x20])/i))
   {
    alert ("한글만 입력해주세요");
    document.mgradd.mgrname.focus();
    document.mgradd.mgrname.select();
    return
   }
   ...
   if(document.mgradd.mgremail.value.match(/^[a-zA-Z0-9_-]+@[a-zA-Z0-9_-]+.[a-zA-Z.]+$/)==null){
      alert("올바른 E-mail 주소가 아닙니다");
   document.mgradd.mgremail.focus();
   document.mgradd.mgremail.select();
   return;
}   
   ...
   if (document.mgradd.mgrsal.value.length>8)
   {
    alert ("최대 1억단위 까지만 입력 가능합니다.");
    document.mgradd.mgrsal.focus();
    document.mgradd.mgrsal.select();
    return
   }
...
<script>
/* function checkid(){
    var id = document.mgradd.mgrid.value;
     var win = window.open("idcheck?id="+id,"Return", "width=370px, height=180px,scrollbars=no,left=750,top=400;");
     popup.focus();
     // POST방식으로 SUBMIT
     var mgradd = document.form.mgradd;
     mgradd.method = "post";
     mgradd.target = "Return";
     mgradd.action = "idcheck";
     mgradd.submit(); 
} */
  ...
  <!-- header시작 -->
   ...
   <!-- body 시작-->
     <div id="body" class="panel-body">
          <!-- 오른쪽 주메뉴 내용시작 -->
          <div id="posts">
          <form class="form-horizontal" name="mgradd" method="post" action="mgradd" >
             <h1>직원등록</h1>
      
             <table class="table table-hover" width="700">
         <tr class="success">
            <td>*이름</td>
            <td><input type="edittext" name="mgrname" id="mgrname"></td>
            <td>*부서</td>
            <td>
            ...
            <tr>
               <td>*생년월일</td>
               <td><input type="text" class="datepicker" name="mgrbirth" id ="mgrbirth"></td>
               <td>*성별</td>
            ...
            <tr>
               <td>*ID</td>
               <td>
               <input type="text" name="mgrid" id= "mgrid" class="width100" maxlength="12">
               <input type="button" id="idcheck" value="중복확인">
               
               </td>
               <td>*Password</td>
               <td><input type="password" name="mgrpw" id="mgrpw"></td>
            </tr>
            <tr>
               <td>*핸드폰</td>
               <td>
               <select name="mgrmobile" >
               ...
               - <input type="text" name="mgrmobile1" maxlength="4" class="width50"  id="mgrmobile1"> - <input type="text" name="mgrmobile2" maxlength="4" class="width50" id="mgrmobile2">
               </td>
               <td>*집전화</td>
               <td>
               <select name="mgrhp" >
               ...
               - <input type="text" name="mgrhp1" maxlength="4" class="width50" id="mgrhp1"> - <input type="text" name="mgrhp2" maxlength="4" class="width50" id="mgrhp2">
               </td>
            </tr>
            <tr>
               <td>*E-mail</td>
               <td><input type="text" name="mgremail" id="mgremail"></td>
               <td>*직급코드</td>
               <td>
               <select name="ranknum">
            ...
            <td>*우편번호</td>
            <td colspan="3">
            <input type="text" name="zipcode1" class="postcodify_postcode6_1 width50"  value="" id="zipcode1"/> &ndash;
            <input type="text" name="zipcode2" class="postcodify_postcode6_2 width50" value=""  id="zipcode2" />
            ...
            <td>*주소</td>
            <td colspan="3">
            <input type="text" name="mgradd1" class="postcodify_address width400" id="mgradd1" />
            </td>            
            </tr>
            <tr>
            <td>*나머지주소</td>
            <td colspan="3">
            <input type="text" name="mgradd2" class="width400" />
            </td>            
            </tr>
            <tr>
               <td>*입사일</td>
               <td><input type="text" class="datepicker2 mgrdate" name="mgrdate"></td>
               <td>*급여</td>
               <td><input type="text" name="mgrsal" id="mgrsal"></td>
            </tr>
         
            <tr>
               <td>자격증</td>
               <td colspan="3">
               <textarea rows="5" class="width500 form-control" name="mgrlicens" ></textarea></td>
            </tr>
            <tr>
               <td>경력사항</td>
               <td colspan="3">
               <textarea rows="5" class="width500 form-control" name="mgrcereer" ></textarea></td>
            </tr>
            <tr>
            <td colspan="3"></td>
               <td align="right"><input type="button" value="취소"><input type="button" value="등록" onclick="check()"></td>
            </tr>
         </table>
         </form>
          </div>
