...
<script language = "javascript">
	function check(){
		...
		if(document.form1.titletitle.value==""){
			alert("내용을 입력해주세요");
			document.getElementById("titletitle").focus();
			return false;
		}
...
<input type="button" id="okBtn" value="확인"> --%>
					...
					<form id="form1" class="form-horizontal" name="form1" method="POST" action="addBoard" >
					
					<div class="table table-hover">
				<div class = "col-lg-8 col-lg-offset-1">
							제목   : <input type="text" class="form-control" id="title" name="title" ><br>
										
							작성자   : <input type="text" class="form-control" id="usrId" name="usrId" value= "${sessionScope.usr.usrId }"  readonly="readonly"><br>
							작성일  : <input type="text" class="form-control" id="boardDate" name="boardDate" value="${calsave}" readonly="readonly"><br>
							내용  : <textarea class="form-control" id="noticecontent" name="titletitle"  rows="8" cols="" ></textarea><br>
										
									  		 <input id="btn" type="button" onclick="check();" class="btn btn-warning" value="등록">
