...
<body>
	...
	<div class="panel panel-default">
		...
		<div id="body" class="panel-body">
			<!-- 오른쪽 주메뉴 내용시작 -->
			<div id="posts">
				<form class="form-horizontal" role="form" method="POST" action="usrUpdate">
					<h1>내 정보</h1>
					<table class="table table-hover">
						...
						<tr>
							<td>*비밀번호</td>
							<td><input type="password" name="usrPw" value="${usr.usrPw }" readonly="readonly"></td>
							<td>*비밀번호 확인</td>
							<td><input type="password" name="usrPw2" value="${usr.usrPw }" readonly="readonly"></td>
						</tr>
						<tr>
							<td>*이름</td>
							<td><input type="text" name="usrName" value="${usr.usrName }" readonly="readonly"></td>
							<td>*E-mail</td>
							<td><input type="email" name="usrEmail" value="${usr.usrEmail }" readonly="readonly"></td>
						</tr>
						<tr>
							<td>*생년월일</td>
							<td><input type="text" id="datepicker" name="usrBirth" value="${usr.usrBirth }" readonly="readonly"></td>
							<td>*성별</td>
							<td>
							${usr.usrGender }
					<!-- 			남 <input type="radio" id="gender" value="M" name="usrGender" > 
						...
						<tr>
							<td>*핸드폰</td>
							<td>
							<select name="usrMobile"  id="usrMobile" readonly="readonly">
									<option value="010">010</option>
									<option value="011">011</option>
									<option value="016">016</option>
									<option value="019">019</option>
							 </select><script language='javascript'>document.getElementById('usrMobile').value="${usr.usrMobile }";</script>
								 - <input type="text" name="usrMobile1" maxlength="4" style="width: 50px;" value="${usr.usrMobile1 }" readonly="readonly">
								 - <input type="text" name="usrMobile2" maxlength="4" style="width: 50px;" value="${usr.usrMobile2 }" readonly="readonly">
							</td>
							<td>*집전화</td>
							<td>
							<select name="usrHp"  id="usrHp" readonly="readonly">
									<option value="02">02</option>
									<option value="031">031</option>
									<option value="032">032</option>
									<option value="054">054</option>
							 </select><script language='javascript'>document.getElementById('usrHp').value="${usr.usrHp }";</script>
								- <input type="text" name="usrHp1" maxlength="4" style="width: 50px;" value="${usr.usrHp1 }" readonly="readonly"> 
								- <input type="text" name="usrHp2" maxlength="4" style="width: 50px;" value="${usr.usrHp2 }" readonly="readonly">
							</td>
						</tr>
						<tr>
							<td>*우편번호</td>
							<td colspan="3">
								<input type="text" name="zipcode1" class="postcodify_postcode6_1" value="${zipCode1 }" id="width50" readonly="readonly"/> &ndash;
								<input type="text" name="zipcode2" class="postcodify_postcode6_2" value="${zipCode2 }" id="width50" readonly="readonly"/>
						...
						<tr>
							<td>*주소</td>
							<td colspan="3">
								<input type="text" name="usrAddr1" class="postcodify_address" value="${usrAddr1 }" id="width400" readonly="readonly"/><br />
							</td>
						</tr>
						<tr>
							<td>*나머지주소</td>
							<td colspan="3">
								<input type="text" name="usrAddr2" value="${usr.usrAddr2 }" id="width400" style="width: 340px;" readonly="readonly"/><br />
							</td>
						</tr>
					</table><br/>
					<div class="form-group">
						<div class="col-lg-offset-3 col-lg-10">
						 	...
						 	<%-- <a href="update?usrId=${usr.usrId}&usrPw=${usr.usrPw}"> --%>
