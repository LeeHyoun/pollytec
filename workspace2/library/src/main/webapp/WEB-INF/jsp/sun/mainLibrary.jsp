	...
	<!-- body ����-->
  	...
  	<div id="body" class="panel-body">
		...
		<div id="libraryinfo" class="posts">
  	  		...
  	  		<p><span>NewStar 도서관</span>을 찾아주셔서 감사합니다.</p>
			<p>안녕하십니까?</p>
			<p>우리 도서관의 홈페이지에 오신것을 진심으로 환영합니다.</p>
			<p>NewStar 도서관에서는 지역 주민 여러분에게 문화욕구 충족과 건전한 여가생활을 제공하고 </p>
			<p>지역정보화를 선도하는 앞서가는 도서관이 되고자 지속적인 노력을 기울이고 있습니다.</p>
  	  	</div>
  	...
  	<div id="footer" class="panel-footer">
  		<div id="mainlogo"><img alt="" src="images/mainFlogo.png"></div>
