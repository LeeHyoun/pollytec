...
$(document).ready(function(){  
	...
	/*  $("search").click(function(){
		 if($("input[name="+genre+"]").val()=={genrecode}){
	...
	<!-- body 시작-->
  	<div id="body" class="panel-body">
		...
		<div id="libraryinfo" class="posts" >
  	  		<h3>장르별 검색</h3>
  	  		<div style="clear:both;font-size:20px;margin:20px;">
  	  		<form method="post"  id="form1" action="selectglist">
  	  			
	  	  		<input type="radio" name="genre" value="1">소설
	  	  		<input type="radio" name="genre" value="2">교육
	  	  		<input type="radio" name="genre" value="3">참고서
	  	  		<input type="radio" name="genre" value="4">잡지
	  	  		<input type="radio" name="genre" value="5">컴퓨터
	  
	  	  		
				  <input type="submit" class="btn btn-default" id="search" value="검색">
			</form>
  	  		</div>
  	  		<div style="clear:both; width:600px;float:left;">
	  	  		<c:forEach items="${genreList}" var="genreList">
	  	  			<div style="clear:both;"></div>
				    <div class="img-thumbnail">
					  <div   class=" bookimg" style="width:400px;">
					      <a href="detailbook?bookno=${genreList.bookNo}">
					      <img src="images/book/${genreList.bookImg}" alt="..." style="width:80px;"></a>
	  	  		<div style="font-size:12px; float:right; width:250px; padding-top:20px;">
	  	  			<p>${genreList.bookTitle}</p>
	  	  			<p>${genreList.bookWriter}</p>
	  	  			<p>${genreList.bookCompany}  |  ${genreList.bookBringout}  |  ${genreList.bookCallnumber}</p>
	  	  		</div>
					    </div>
				 	 </div>
			...
			<div align="center">
				<div class="row">
			  	<div class="col-md-9 col-lg-9">
			  		<nav>
			  			<ul class="pagination">
			  					<li><a href="selectglist?page=1&genre=${genrecode}" ><span aria-hidden="true">처음</span></a></li>
			   					<li><a href="selectglist?page=${prevpageno}&genre=${genrecode}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
			   				 <c:forEach begin="${gstart}" end="${gend}"   var="i">
			   				 	
			   				  		<li><a href="selectglist?page=${i}&genre=${genrecode}">${i}</a></li>
			   				  	
			   				</c:forEach>
			   				
			   				<li><a href="selectglist?page=${nextpageno}" aria-label="Next"><span aria-hidden="true">&raquo;</span></a></li>
			   				<li><a href="selectglist?page=${totalpage}" aria-label="Next"><span aria-hidden="true">마지막</span></a></li>
			 			 </ul>
					</nav>
				</div>
				</div>
