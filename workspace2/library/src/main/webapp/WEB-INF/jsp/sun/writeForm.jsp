		 ...
		 <div id="notice">
			  ...
			  <!-- 게시판 글쓰기 폼 -->
				<div class="row">
			  	...
			  	<form id="form1" class="form-horizontal" name="form1" method="POST" action="noticewrite" >
			  		제목      : <input type="text" class="form-control" id="noticetitle" name="noticetitle" placeholder="" ><br>
			  		작성자    : <input type="text" class="form-control" id="mgrname" name="mgrname" placeholder="${mgrdto.mgr_name}" value="${mgrdto.mgr_name}"><br>
			  		작성자ID : <input type="text" class="form-control" id="mgrid" name="mgrid" placeholder="${mgrdto.mgr_id}"  value="${mgrdto.mgr_id}" ><br>
			  		내용      : <textarea class="form-control" id="noticecontent" name="noticecontent"  rows="8" cols="" ></textarea>
			  		 
			  	
			  		
				  		 <input id="btn" type="button" onclick="check1();" class="btn btn-warning" value="등록">
