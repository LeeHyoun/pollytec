	...
	<!-- body 시작-->
  	<div id="body" class="panel-body">
		...
		<div id="libraryinfo" class="posts" >
  	  		...
  	  		<form id="searchbox" class="navbar-form navbar-left" method="POST" role="search" action="titlesearch2">
			  <div class="form-group">
			  ...
			  <input type="submit" class="btn btn-default" value="검색">
  	  		...
  	  		<div style="clear:both; width:600px;">
	  	  		<c:forEach items="${gettitlelist}" var="gettitlelist">
	  	  			<div style="clear:both;"></div>
				    <div class="img-thumbnail">
					  <div   class=" bookimg" style="width:400px;">
					      <a href="detailbook?bookno=${gettitlelist.bookNo}">
					      <img src="images/book/${gettitlelist.bookImg}" alt="..." style="width:80px;"></a>
	  	  		<div style="font-size:12px; float:right; width:250px; padding-top:20px;">
	  	  			<p>${gettitlelist.bookTitle}</p>
	  	  			<p>${gettitlelist.bookWriter}</p>
	  	  			<p>${gettitlelist.bookCompany}  |  ${gettitlelist.bookBringout}  |  ${gettitlelist.bookCallnumber}</p>
	  	  		</div>
					    </div>
				 	 </div>
			...
			<div align="center">
				<div class="row">
			  	<div class="col-md-9 col-lg-9">
			  		<nav>
			  			<ul class="pagination">
			  					<li><a href="titlesearch2?page=1&search=${search}" ><span aria-hidden="true">처음</span></a></li>
			   					<li><a href="titlesearch2?page=${prevpageno}&search=${search}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
			   				 <c:forEach begin="${gstart}" end="${gend}"   var="i">
			   				 	
			   				  		<li><a href="titlesearch2?page=${i}&search=${search}">${i}</a></li>
			   				  	
			   				</c:forEach>
			   				
			   				<li><a href="titlesearch2?page=${nextpageno}&search=${search}" aria-label="Next"><span aria-hidden="true">&raquo;</span></a></li>
			   				<li><a href="titlesearch2?page=${totalpage}&search=${search}" aria-label="Next"><span aria-hidden="true">마지막</span></a></li>
			 			 </ul>
					</nav>
				</div>
				</div>
