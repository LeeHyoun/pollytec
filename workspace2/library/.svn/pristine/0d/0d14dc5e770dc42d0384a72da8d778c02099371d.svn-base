...
public class MgrUsrDTO {
	...
	private String usrMobile3;
	private String usrHp;
	private String usrHp1;
	private String usrHp2;
	private String usrHp3;
	...
	public String getUsrMobile3() {
		return usrMobile3;
	}
	public void setUsrMobile3(String usrMobile3) {
		this.usrMobile3 = usrMobile3;
	}
	public String getUsrHp() {
		return usrHp;
	}
	
	public String getUsrHp1() {
		return usrHp1;
	}
	public void setUsrHp1(String usrHp1) {
		this.usrHp1 = usrHp1;
	}
	public String getUsrHp2() {
		return usrHp2;
	}
	public void setUsrHp2(String usrHp2) {
		this.usrHp2 = usrHp2;
	}
	public String getUsrHp3() {
		return usrHp3;
	}
	public void setUsrHp3(String usrHp3) {
		this.usrHp3 = usrHp3;
	}
	...
	public String getUsrIndate() {
		return usrIndate;
	}
	public void setUsrIndate(String usrIndate) {
		this.usrIndate = usrIndate;
	}
	@Override
	public String toString() {
		return "MgrUsrDTO [rownum=" + rownum + ", usrId=" + usrId
				+ ", usrName=" + usrName + ", usrPw=" + usrPw + ", usrGender="
				+ usrGender + ", usrBirth=" + usrBirth + ", usrEmail="
				+ usrEmail + ", usrMobile=" + usrMobile + ", usrMobile1="
				+ usrMobile1 + ", usrMobile2=" + usrMobile2 + ", usrMobile3="
				+ usrMobile3 + ", usrHp=" + usrHp + ", usrHp1=" + usrHp1
				+ ", usrHp2=" + usrHp2 + ", usrHp3=" + usrHp3 + ", usrAddr1="
				+ usrAddr1 + ", usrAddr2=" + usrAddr2 + ", usrIndate="
				+ usrIndate + "]";
	}
