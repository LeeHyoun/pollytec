	...
	<!-- body 시작-->
  	<div id="body" class="panel-body">
		...
		<div id="libraryinfo" class="posts" >
  	  		...
  	  		<form id="searchbox" class="navbar-form navbar-left" role="search" method="POST" action="writersearch2">
			  <div class="form-group">
  	  		...
  	  		<div style="clear:both; width:600px;">
				    ...
				    <div class="img-thumbnail">
					  <div   class=" bookimg" style="width:400px;">
					      <a href="detailbook?bookno=${booklist.bookNo}">
					      <img src="images/book/${booklist.bookImg}" alt="..." style="width:80px;"></a>
	  	  		<div style="font-size:12px; float:right; width:250px; padding-top:20px;">
	  	  			<p>${booklist.bookTitle}</p>
	  	  			<p>${booklist.bookWriter}</p>
	  	  			<p>${booklist.bookCompany}  |  ${booklist.bookBringout}  |  ${booklist.bookCallnumber}</p>
	  	  		</div>
					    </div>
				 	 </div>
