	...
	<!-- body 시작-->
  	<div id="body" class="panel-body">
		...
		<div id="libraryinfo" class="posts" >
  	  		...
  	  		<form method="post" action="selectglist" style="margin:20px;">
  	  		...
  	  		<div style="clear:both; width:600px;">
				    ...
				    <div class="img-thumbnail">
					  <div   class=" bookimg" style="width:400px;">
					      <a href="detailbook?bookno=${getimglist.bookNo}">
					      <img src="images/book/${getimglist.bookImg}" alt="..." style="width:80px;"></a>
	  	  		<div style="font-size:12px; float:right; width:250px; padding-top:20px;">
	  	  			<p>${getimglist.bookTitle}</p>
	  	  			<p>${getimglist.bookWriter}</p>
	  	  			<p>${getimglist.bookCompany}  |  ${getimglist.bookBringout}  |  ${getimglist.bookCallnumber}</p>
	  	  		</div>
					    </div>
				 	 </div>
	      ...
	      <ul>
	        <li>
	          ...
	          <ul style="background: url(images/img10.gif) repeat-x;">
	            ...
	            <li style="background: url(images/img03.gif) repeat-x left bottom;"><a href="#">저자</a></li>
	          </ul>
	        </li>
	      </ul>
	    </div>
