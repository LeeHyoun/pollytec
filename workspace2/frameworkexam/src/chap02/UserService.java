...
public class UserService implements BeanNameAware//, BeanClassLoaderAware, BeanFactoryAware, ResourceLoaderAware, ApplicationEventPublisherAware, MessageSourceAware, ApplicationContextAware
{
	...
	public void setBeanName(String beanId) {
		System.out.println("BeanNameAware 인터페이스의 메소드 setBeanName."
				+ " 초기화되는 Bean의 Id를 전달 받는다. :" + beanId);
	}
	

	/*@Override
	public void setBeanClassLoader(ClassLoader classLoader) {
		System.out.println("BeanClassLoaderAware 인터페이스의 메소드 setBeanClassLoader."
				+ " 스프링 컨테이너가 사용하는 ClassLoader를 전달한다.");
	}

	@Override
	public void setBeanFactory(BeanFactory beanFactory) throws BeansException {
		System.out.println("BeanFactoryAware 인터페이스의 메소드 setBeanFactory. 컨테이너 자체를 넘겨받는다. "
				+ "빈 클래스 안에서 스프링 팩토리를 사용하고자 할 경우 사용한다.");
	}
	...
	public void setApplicationContext(ApplicationContext applicationContext)
		...
		System.out.println("ApplicationContextAware 의 setApplicationContext 메소드 호출."
				+ " ApplicationContext를 사용할 경우 컨테이너를 전달");
	}*/
